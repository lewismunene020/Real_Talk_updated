...
matched_passwords('#password1' , '#password2' , '.error-indicator');
    ...
    function  validate(){
        let  pass1_val = pass1.value ,pass2_val = pass2.value
            ...
            if(  (len1 < 4) || (len2 < 8) ){
                ...
                ajax_connector('#new-password-up-btn' , '.new-password-form' , '/Real_Talk/php_files/new-password.php' , '.error-indicator')
